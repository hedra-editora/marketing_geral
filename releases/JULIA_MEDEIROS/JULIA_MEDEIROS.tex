...
\subject{Obras completas de Júlia Lopes de Almeida}

Nos 90 anos de morte de Júlia Lopes de Almeida, a Editora Hedra
...
\item Correio da roça (romance)
\item A Silveirinha (romance)
\item A casa verde (romance)
\item Pássaro tonto (romance)
\item O funil do diabo (romance)
\item Contos e novelas (Volume 1) 
\item Contos e novelas (Volume 2) 
\item Teatro 
\item Crônicas e crônicas de viagem 
