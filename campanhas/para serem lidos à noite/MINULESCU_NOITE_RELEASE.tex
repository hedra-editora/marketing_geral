...
\starttext
{\bfc Para serem lidas à noite\\} 
{\tfb Ion Minulescu}

\blank[big]


\noindent {\it Obra fantástica de Ion Minulescu, voz máxima do modernismo romeno,} Para serem lidas à noite {\it reúne quatro histórias cheias de mistérios. Com humor e ironia, os contos exploram as complexidades da condição humana em uma atmosfera noturna envolvente.}
