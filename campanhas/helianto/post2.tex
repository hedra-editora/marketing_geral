...
\definecolor[MyColor][x=452562]      % ou ex: [r=0.862, g=0.118, b=0.118] % corresponde a RGB(220, 30, 30)
\definecolor[MyColorText][x=dfc580]  % ou ex: [r=0.862, g=0.118, b=0.118] % corresponde a RGB(167, 169, 172)
...
\startMyCampaign\hyphenpenalty=10000

%«TODA {\bf PALAVRA}, MESMO A MAIS {SECRETA OUSADIA}, É UM {\bf RECOMEÇO}.»
«O {\bf DESTINO}, NÃO O {\bf DESTINO} DOS DIAS, MAS O DE {\bf TODO O SEMPRE}, ESSA {\bf LONGA VIAGEM SEM RETORNO}».\blank[small]

\hfill---Orides Fontela
\stopMyCampaign
...
\MyPicture{004}
{\tfx{\bf Orides Fontela} (1940--1998) nasceu em São João da Boa Vista, São Paulo.
{\bf Transposição}, seu primeiro livro, foi publicado em 1969.}
