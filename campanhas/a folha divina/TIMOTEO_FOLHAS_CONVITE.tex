...
% Cabeço e rodapé: Informações (caso queira trocar alguma coisa)
    \def\MensagemSaibaMais  {PONTA DE LANÇA}
    \def\MensagemSite   {RUA AURELIANO COUTINHO, 26}
    \def\MensagemLink       {15 DE NOVEMBRO ÀS 19H}
...
\node at (28mm,-100mm) {\externalfigure[LOGO_LIVRARIA.png][width=1cm]};
\stoptikzpicture
...
%Explora também o conceito de «bem viver» e a importância da preservação da Mata Atlântica. 
%: no início dos tempos, Nhanderu, que criou o mundo, transformou sua filha moça em uma árvore de erva-mate, ou «ka’a miri’i», cujas folhas trazem alegria e força
%Além disso, «A folha divina» aborda a apropriação capitalista da erva-mate, explorada há séculos pelos «juruá», o que contribui para a devastação das matas nativas.

\blank[7ex]

\starttikzpicture[remember picture,overlay]
\node at (26mm,-5mm) {\scale[factor=45]{\MyPortrait{TIMOTEO_FOLHA_FOTO_PB}}\hspace[big]\scale[factor=45]{\MyPortrait{TIMOTEO_ANITA_FOLHA_FOTO_PB}}};
\stoptikzpicture
