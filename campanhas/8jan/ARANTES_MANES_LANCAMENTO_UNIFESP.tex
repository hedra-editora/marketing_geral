...
\Mensagem{EVENTO + DEBATE}

\startMyCampaign
{\bf 8/1: A REBELIÃO DOS MANÉS}
\stopMyCampaign
{\scale[factor=5]{\Seta\,{\bf CONVIDADOS} Pedro Arantes, Fernando Frias,}
\setupinterlinespace[line=1.7ex]\scale[factor=5]{Maria L. Meneses e Rita Von Hunty}}

\vfill

% Colocar sempre imagens quadradas
\scale[factor=fit]{\MyPortrait{ARANTES_MANES_AUTOR-PEDROQUADRADO}\quad\MyPortrait{ARANTES_MANES_AUTOR-FERNANDOQUADRADO}\quad\MyPortrait{ARANTES_MANES_AUTOR-MARIAQUADRADO}\quad\MyPortrait{ARANTES_MANES_CONVIDADO_hunty}}

\blank[medium]

\scale[factor=fit]{\Seta\,{\bf XX DE XXXX XXH} NA EFLCH-UNIFESP}
...
A turnê de lançamento do livro {\bf 8/1: A REBELIÃO DOS MANÉS} aterrissa na casa dos autores e terá a participação especial de {\bf RITA VON HUNTY}, para uma conversa sobre os temas do livro.
