...
\stopMyCampaign
{\scale[factor=5]{\Seta\,{\bf CONVIDADO} Pedro Arantes}
%\setupinterlinespace[line=1.7ex]\scale[factor=5]{Fulano de Tal}}

\vfill
\startlinealignment[middle]
% Colocar sempre imagens quadradas
\scale[factor=90]{\MyPortrait{ARANTES_MANES_AUTOR-PEDROQUADRADO}}
%\quad\MyPortrait{ARANTES_MANES_AUTOR-FERNANDOQUADRADO}\quad\MyPortrait{ARANTES_MANES_AUTOR-MARIAQUADRADO}\quad\MyPortrait{FOTO_FULANO_DE_TAL}}
\stoplinealignment

\blank[medium]

\scale[factor=fit]{\Seta\,{\bf 26 DE ABRIL 11H} NO YOUTUBE}
...
O Programa 20 Minutos, do Opera Mundi, fará uma entrevista com Pedro Arantes sobre o livro {\bf 8/1: A REBELIÃO DOS MANÉS}, de sua autoria, juntamente com Fernando Frias e Maria Luiza Meneses.

\vfill

Evento ocorre no canal do Opera Mundi no YouTube e terá sorteio de um exemplar do livro para a platéia.
