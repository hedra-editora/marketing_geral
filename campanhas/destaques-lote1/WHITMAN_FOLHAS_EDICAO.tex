...
Esta edição de {\bf FOLHAS DE RELVA}, livro fundador da poesia norte-americana moderna, é o resultado de {\bf SETE DIFERENTES VERSÕES}, escritas entre 1855 a 1891.

\page

 Ridicularizada pela crítica por seu caráter experimental e temáticas polêmicas, a obra aborda um período em que os {\cap EUA} aproximavam-se da {\bf MODERNIDADE}, ao mesmo tempo em que\\
...
«A {\bf EDIÇÃO DO LEITO DE MORTE} marca a consolidação de um percurso tortuoso que condensa algumas das mais importantes conquistas da técnica literária moderna e a busca de uma incerta {\bf POESIA NACIONAL} em um momento crítico da sociedade norte-americana.»
