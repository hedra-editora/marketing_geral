...
{\bf SEMIFINALISTAS\\ DO JABUTI ACADÊMICO}
\stopMyCampaign
...
% \node at (7,.5) {\externalfigure[JABUTI][height=0.2\textheight]};
% \stoptikzpicture


\node at (7.5,-4.7) {\externalfigure[JABUTI][height=0.2\textheight]};
\stoptikzpicture
\page %---------------------------------------------------------| 
...
{\bf CRIME} é o sétimo volume, um livro dividido em oito partes. A primeira delas apresenta três artigos sobre a discussão teórica acerca da {\bf DEFESA CONCRETA DE ESCRAVIZADOS}. São textos sobre a importância da identificação dos limites de uma
jurisdição.

\page %---------------------------------------------------------|

 {\bf DIREITO}, o quinto volume, reúne {\bf TEXTOS PUBLICADOS PELO AUTOR NA
 IMPRENSA, ALÉM DE CARTAS PESSOAIS}, logo depois de sua demissão do cargo de amanuense da Secretaria
de Polícia de São Paulo. Foi lá que Gama aprofundou o conhecimento dos ritos processuais e do repertório normativo 
...
\blank[1ex]
\scale[factor=8]{\Seta\,{\bf Bruno Rodrigues de Lima}}
