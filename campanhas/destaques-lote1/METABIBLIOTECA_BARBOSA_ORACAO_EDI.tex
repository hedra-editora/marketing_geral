...
\definecolor[MyColor][GreenYellow]      % ou ex: [r=0.862, g=0.118, b=0.118] % corresponde a RGB(220, 30, 30)
...
\MyCover{METABIBLIOTECA_BARBOSA_ORACAO_THUMB.pdf}

\page %---------------------------------------------------------|

\MyPicture{METABIBLIOTECA_BARBOSA_ORACAO_1.jpeg}

\page 


\MyPicture{METABIBLIOTECA_BARBOSA_ORACAO_2.jpeg}
