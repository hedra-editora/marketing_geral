...
\definecolor[MyColorText][CharcoalGray]  % ou ex: [r=0.862, g=0.118, b=0.118] % corresponde a RGB(167, 169, 172)
...
\MyCover{METABIBLIOTECA_AZEVEDO_PELE_THUMB.pdf}

\page %---------------------------------------------------------|

\MyPicture{METABIBLIOTECA_AZEVEDO_PELE_1.jpeg}
