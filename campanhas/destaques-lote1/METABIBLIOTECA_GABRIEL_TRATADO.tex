...
\definecolor[MyColorText][BlueI]  % ou ex: [r=0.862, g=0.118, b=0.118] % corresponde a RGB(167, 169, 172)
...
\MyCover{METABIBLIOTECA_GABRIEL_TRATADO_THUMB.pdf}

\page %---------------------------------------------------------|

\MyPicture{METABIBLIOTECA_GABRIEL_TRATADO_1}
