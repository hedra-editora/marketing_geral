...
\definecolor[MyColor][Goldenrod]      % ou ex: [r=0.862, g=0.118, b=0.118] % corresponde a RGB(220, 30, 30)
\definecolor[MyColorText][VenetianRed]  % ou ex: [r=0.862, g=0.118, b=0.118] % corresponde a RGB(167, 169, 172)
...
\Mensagem{PARA ALÉM DO REAL IMEDIATO}
...
As peças reunidas --- «O marinheiro», «A morte do príncipe»,  «Diálogo no jardim do palácio», «Salomé» e  «Sakyamuni» --- são provavelmente as mais acabadas dentre os muitos fragmentos deixados por seu autor, e apresentam como {\bf EIXO COMUM} a concepção pessoana de êxtase.
...
{\vfill\scale[factor=5]{{\bf Caio Gagliardi},}\setupinterlinespace[line=1.5ex]\scale[factor=5]{professor da Universidade de São Paulo,}\setupinterlinespace[line=1.5ex]\scale[factor=5]{na introdução de {\bf TEATRO DO ÊXTASE}}}
