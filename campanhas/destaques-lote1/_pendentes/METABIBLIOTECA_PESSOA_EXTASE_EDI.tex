...
\definecolor[MyColorText][Peridot]  % ou ex: [r=0.862, g=0.118, b=0.118] % corresponde a RGB(167, 169, 172)
...
\MyCover{METABIBLIOTECA_PESSOA_EXTASE_THUMB.pdf}

\page %---------------------------------------------------------|

\MyPicture{METABIBLIOTECA_PESSOA_EXTASE_2.jpeg}

\page 


\page 
\MyPicture{METABIBLIOTECA_PESSOA_EXTASE_1.jpeg}


\MyPicture{METABIBLIOTECA_PESSOA_EXTASE_3.jpeg}
