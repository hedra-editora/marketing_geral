...
{\bf Diário pariesiense e outros escritos}, reunião de quinze textos do crítico dos anos 1926 a 1936,  integra a {\it Coleção Walter Benjamin}. Em uma organização inédita, a edição traz a primeira tradução em língua portuguesa de seu diário redigido em Paris, o qual nomeia a obra, e além de textos como “Três franceses”, “Imagem de Proust”, “Édipo ou o mito racional”.

\page

{\it As traduções dos textos desta coletânea, em parte inéditos em língua portuguesa, seguem o caráter experimental de perto, buscando a fidelidade como critério, uma proximidade quase unilateral ao texto.}
{\blank[.4ex]}
