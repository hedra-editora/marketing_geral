...
Ela apenas colocou novas
classes, novas condições de opressão, novas estruturas de luta no lugar
das antigas.»

\stopMyCampaign

{\vfill\scale[factor=6]{\Seta\,Trecho do livro {\bf Manifesto Comunista}, de}\setupinterlinespace[line=1.5ex]\scale[factor=6]{Karl Marx e Friedrich Engels.}}
