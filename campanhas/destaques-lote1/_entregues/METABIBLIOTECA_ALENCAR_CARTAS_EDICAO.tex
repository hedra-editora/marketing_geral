...
\definecolor[MyColor][x=2BDB00]      % ou ex: [r=0.862, g=0.118, b=0.118] % corresponde a RGB(220, 30, 30)
\definecolor[MyColorText][yellow]     % ou ex: [r=0.862, g=0.118, b=0.118] % corresponde a RGB(167, 169, 172)
...
\Mensagem{ESCRAVIDÃO E LITERATURA}
...
Quando {\bf JOSÉ DE ALENCAR} era ministro da justiça do Império do Brasil,
articulou uma {\bf DEFESA DA ESCRAVIDÃO BRASILEIRA}, 
e escreveu uma carta aberta a Dom Pedro {\cap II}.
