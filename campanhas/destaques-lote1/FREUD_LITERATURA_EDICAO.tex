...
{\bf ESCRITOS SOBRE LITERATURA} reúne textos que, de certa forma, resgatam  o «débito» de {\bf FREUD} com a
 {\bf HISTÓRIA LITERÁRIA}.

\page

 Foi pelo {\bf DIÁLOGO COM AS PRODUÇÕES LITERÁRIAS} que Freud pôde conceber e dar forma para as suas criações conceituais, incluindo sua hipótese mais famosa e fundamental, o {\bf «COMPLEXO DE ÉDIPO»}, a qual remete à estrutura narrativa de uma peça de {\bf SÓFOCLES}. 


\page

Entretanto, nesse livro {\bf AS POSIÇÕES SE INVERTEM: A PSICANÁLISE SE VOLTA PARA A LITERATURA} usando seus novos recursos para reinterpretá-la. Aqui, as obras literárias não estão mais a serviço de uma teoria psicanalítica, mas constituem \bf{OBJETO CENTRAL DA ANÁLISE}.
