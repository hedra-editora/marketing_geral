...
A falta, o vazio, as contradições, as tensões, os {\bf DESENCONTROS QUE CARACTERIZAM O SENTIMENTO AMOROSO} são alguns dos temas do livro, que vai na contramão do ideal romântico e burguês do amor.
...
Crônica sentimental peculiar, «Mulheres» não é uma coleção de conquistas. Ştefan Valeriu, personagem principal e elo entre as quatro histórias do livro é, em última análise, {\bf UM HOMEM SEM CONTORNOS DEFINIDOS} (ou ao menos revelados). As mulheres citadas por Ştefan, portanto, o «fazem e definem».

{\vfill
\scale[factor=5]{\Seta\,Tradução de Fernando Klabin, {\bf direta do romeno}.}
\setupinterlinespace[line=1.5ex]\scale[factor=5]{De R\$\,49,00 {\bf por R\$\,31,50}, 152 páginas, 1ª edição.}}
