...
--- Cuidado! Não vá expender ideias de progresso e humanidade no seio da sua fazenda. 
...
{\vfill\scale[factor=6]{\Seta\,Trecho do livro {\bf A família Medeiros}, de Júlia}\setupinterlinespace[line=1.5ex]\scale[factor=6]{Lopes de Almeida.}}
