...
\inoutermargin[width=70mm,hoffset=-5.5cm,voffset=20.3cm,style=tfx]
{\definefontfamily [Times] [rm] [Times New Roman]
                   [tf=file:TimesLTStd-Roman.otf]
...
\inoutermargin[width=70mm,hoffset=-5.5cm,voffset=19.7cm,style=tfx]
{\definefontfamily [Times] [rm] [Times New Roman]
                   [tf=file:TimesLTStd-Roman.otf]
...
\noindent Quase uma década depois da sua primeira publicação, a nova edição bilíngue de {\it Lira grega} revisa e expande a obra.
