...
«Ainda que o {\cap TUSP} não fosse um grupo de teatro político em sentido estrito, sua atividade sempre dialogou com ações culturais militantes. 
\vfill\hfill →

\page


E boa parte do coletivo colaborou com grupos de resistência à ditadura.
\vfill\hfill →

\page

Havia, portanto, um jogo entre se assumir e não se assumir como um teatro político, diante do contexto de perseguições e censura promovidas pela ditadura.»
