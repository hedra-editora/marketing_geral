...
\node at (50mm,-106mm) {\setcharacterkerning[reset]\Times\MyColorText\switchtobodyfont[15pt] hedra};
\node at (-9mm,-106mm) {\externalfigure[logo_proac.png][width=2cm]};
\node at (10.5mm,-106mm) {\externalfigure[logo_cult.png][width=1.2cm]};
\node at (30mm,-105mm) {\externalfigure[logo_gov_2.png][width=2cm]};
