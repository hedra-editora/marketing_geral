...
\Mensagem{Destaques}
		...
		\vfill
		\startMyCampaignSection \Seta ENTENDENTENDO A PRONÛNCIA 

		CHINESA   \stopMyCampaignSection
...
\MyCover{LAOZI_DAODEJING_CAPA-rede.pdf}

\page %---------------------------------------------------------|

\MyPicture{LAO-image-1.jpeg}
...
Laozi, também conhecido como Lao Tzu, Laotze e Lao Tsé, é o primeiro e mais
importante autor do taoísmo chinês. Acredita-se que seu verdadeiro nome era
Li Er. ase nada se sabe sobre sua vida

% Tradução: Mario Bruno Sproviero, doutor em Filosofia pela Universidade de
% São Paulo e estudioso da língua e da cultura chinesas.

% #HedraEdições #Laozi #Taoteding
