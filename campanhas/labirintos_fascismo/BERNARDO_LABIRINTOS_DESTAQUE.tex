...
{\vfill\scale[factor=6]{\Seta\,Trecho do livro {\bf Labirintos do fascismo,}}\setupinterlinespace[line=1.5ex]\scale[factor=6]{{\bf vol. 6: Metamorfoses do fascismo},}\setupinterlinespace[line=1.5ex]\scale[factor=6]{de João Bernardo.}}
