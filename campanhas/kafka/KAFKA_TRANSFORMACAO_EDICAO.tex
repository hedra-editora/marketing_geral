...
{\bf METAMORFOSE OU TRANSFORMAÇÃO?}

O HUMOR POR TRÁS \\DA TRADUÇÃO
...
{\it Metamorfose} carrega uma conotação mais biológica e específica, associada a mudanças naturais e inevitáveis, como a metamorfose de uma lagarta em borboleta, e induz a pensar em um personagem trágico e triste, evocando uma mudança biológica dolorosa. Por outro lado, {\it transformação} sugere uma conotação mais psicológica, o que abre a narrativa para o {\bf LÚDICO, O TOM JOCOSO E HUMORÍSTICO}.

\page %---------------------------------------------------------| 

\placefigure{}{\externalfigure[KAFKA_TRANSFORMACAO_2.jpeg][width=\textwidth]}
...
O escritor argentino {\bf JORGE LUIS BORGES} também criticava o título
...
crítico {\bf OTTO MARIA CARPEAUX}, em um texto de 1941, marco inaugural da
