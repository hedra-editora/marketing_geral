...
\page %---------------------------------------------------------|
 ...
 «Blecher trata da {\bf PRECARIEDADE E DA FRAGILIDADE DA VIDA}, da vitimização do homem pelo destino, do triunfo inexorável da morte mas, ao mesmo tempo, do {\bf POTENCIAL DE ETERNIDADE QUE HABITA CADA INSTANTE}. 

\vfill\hfill →

\page

 Como no diálogo entre Alice e o coelho, em Alice no país das maravilhas, de Lewis Carroll, quando Alice pergunta: “Quanto tempo dura a eternidade?” e recebe como resposta: “Às vezes, um instante”.»
