...
\noindent {\it A partir da sua experiência em sanatórios, Blecher produziu} A toca iluminada, {\it uma obra assombrosa que registra seu lento caso com a morte, visionária em suas incursões metafísicas e insuportavelmente concreta em seu retrato da dor física e da degradação.}
...
\inoutermargin[width=60mm,hoffset=1cm,style=tfx,,voffset=1.4cm]{
\externalfigure[BLECHER_TOCA_THUMB][width=50mm]
}


\inoutermargin[width=70mm,hoffset=1.1cm,voffset=2.3cm,style=tfx]
...
\noindent Publicado postumamente em 1971, {\em A toca iluminada: diário de sanatório} é estruturado a partir de eventos biográficos de Max Blecher, o “Kafka romeno”. Em meio ao período que esteve internado em um sanatório, o escritor confronta-se com os limites da memória e busca capturar momentos de sua vida enquanto esvaem-se como “cinzas que passam por uma peneira”. Focando em cada instante narrado, a narrativa de Blecher transcorre na fronteira entre a realidade e o sonho. 
