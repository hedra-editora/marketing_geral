...
«Em três aspectos a história pertence ao vivente: enquanto indivíduo atuante e determinado, enquanto
conservador e reverente, e enquanto sofredor e carente de libertação.»

\stopMyCampaign


{\vfill\scale[factor=5]{\Seta\,Trecho do livro {\bf Sobre a utilidade e a desvantagem}}\setupinterlinespace[line=1.5ex]\scale[factor=5]{{\bf da história para a vida}, de Nietzsche.}}
