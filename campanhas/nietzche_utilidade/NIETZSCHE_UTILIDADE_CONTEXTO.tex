...
\Mensagem{FILOSOFANDO} %Sempre usar esse header
...
%               [width=.7\textwidth]};
% \stoptikzpicture
{\bf PARA NIETZSCHE,\\ O QUE SERIA\\ A DOENÇA DO
...
Dada a impossibilidade de nos desvencilharmos da história, pois o homem é um ser histórico, cabe saber até que ponto ela {\bf AUXILIA OU PREJUDICA A VIDA}.
Sua crítica não se reduz à disciplina histórica, mas às consequências que essa prática pode ter em toda uma cultura.
