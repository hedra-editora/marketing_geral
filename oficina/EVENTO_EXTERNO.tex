...
% CARD COLORIDO %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \node[anchor=north west] at ([yshift=-2mm]C)    {\bf HEDRA NA};
  \node[anchor=north west] at ([yshift=-1mm]A5)   {\bf FEIRA DA USP};
  \node[anchor=north west] at ([yshift=-1mm]A4)   {\bf };
  \node[anchor=north west] at ([yshift=-1mm]A3)   {13.03.2024};
  \node[anchor=north west] at ([yshift=-1mm]A2)   {10 ÀS 20H};
  \node[anchor=north west] at ([yshift=-1mm]A1)   {};     
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
